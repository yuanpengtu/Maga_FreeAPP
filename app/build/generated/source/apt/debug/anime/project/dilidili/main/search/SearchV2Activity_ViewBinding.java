...
public class SearchV2Activity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public SearchV2Activity_ViewBinding(SearchV2Activity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SearchV2Activity_ViewBinding(SearchV2Activity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchV2Activity target = this.target;
